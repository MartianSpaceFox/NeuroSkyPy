...
setup(
    ...
    download_url=
    f"https://github.com/Jor-G-ete/NeuroSkyPy/archive/v{version}.tar.gz",
    project_urls={
        "Documentation":
        "https://github.com/Jor-G-ete/NeuroSkyPy",
        "Source Code":
        "https://github.com/Jor-G-ete/NeuroSkyPy/blob/master/NeuroSkyPy/NeuroSkyPy.py",
    },
    platforms="Windows",
